...
Public Const SERVICIO_FACTURACION_ELECTRONICA As String = "wsfe"
Public Const SERVICIO_LIQUIDACION_PRIMARIA_GRANOS As String = "wslpg"

Public Const SOLICITUD_CAE_RESULTADO_ACEPTADO As String = "A"
Public Const SOLICITUD_CAE_RESULTADO_RECHAZADO As String = "R"
Public Const SOLICITUD_CAE_RESULTADO_PARCIAL As String = "P"

Public Sub PruebaWSLPG()
